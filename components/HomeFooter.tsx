...
export default function HomeFooter() {
  return (
    <footer className="bg-[#381c11] text-[#fffdf4] px-[clamp(16px,5vw,72px)] pt-[clamp(48px,7vw,96px)] pb-8 relative overflow-hidden">
      ...
      <div
        className="absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[rgba(250,169,38,0.06)] blur-3xl pointer-events-none"
        aria-hidden="true"
      />

      <div className="mx-auto w-full max-w-[1380px] relative z-10">
        {/* Top Order Callout Banner */}
        <div className="mb-14 rounded-[32px] border border-[rgba(255,255,255,0.12)] bg-gradient-to-r from-[rgba(250,169,38,0.15)] to-[rgba(255,255,255,0.03)] p-8 md:p-10 backdrop-blur-md flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="max-w-[620px]">
            <div className="inline-flex items-center gap-2 rounded-full bg-[var(--home-golden)]/20 px-3.5 py-1 text-xs font-black uppercase tracking-wider text-[var(--home-golden)] mb-3">
              <span>🍦</span> Express Delivery in Lahore
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-[52px] shrink-0 items-center justify-center gap-2.5 rounded-full bg-[var(--home-golden)] px-8 text-sm font-black text-[#381c11] shadow-lg transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0 focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-[var(--home-golden)]"
          >
            Order on WhatsApp
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 pb-14 border-b border-white/10">
          ...
          <div className="md:col-span-5 lg:col-span-4 space-y-4">
            ...
            >
              <Image
                ...
                height={500}
                sizes="80px"
                className="h-auto w-[76px] drop-shadow-md"
                loading="lazy"
              />
              <div>
                ...
                <span className="block text-xs font-black uppercase tracking-[0.14em] text-[var(--home-golden)]">
                  Ice Cream
                </span>
              </div>
            </Link>
          ...
          <div className="md:col-span-3 lg:col-span-3">
            <h4 className="text-xs font-black uppercase tracking-[0.16em] text-[var(--home-golden)] mb-4">
              Explore Menu
            </h4>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <ul className="space-y-3 text-sm font-semibold text-white/75">
              ...
              <li>
                <a
                  href="#visit"
                  className="inline-flex items-center gap-1.5 text-xs font-black uppercase tracking-wider text-[var(--home-golden)] hover:underline"
                >
            ...
            <ul className="flex lg:flex-col flex-wrap gap-3">
              {SOCIAL_LINKS.map((link) => (
                <li key={link.href}>
                  ...
                  >
                    <span className="h-1.5 w-1.5 rounded-full bg-[var(--home-golden)]" />
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-white/60">
          <p>© {new Date().getFullYear()} ConeJoy&apos;s Ice Cream. All rights reserved.</p>
          <a
          ...
          >
            ...
            <span className="font-extrabold text-[var(--home-golden)]">MAVPLO</span>
            <span className="text-white/40">· mavplo.com</span>
          </a>
        </div>
      </div>
    </footer>
