...
export default function HomeFooter() {
  return (
    <footer className="border-t border-ink/50 bg-panel px-[clamp(16px,5vw,72px)] py-8 text-ink">
      <div className="mx-auto flex w-full max-w-[1380px] items-center justify-between gap-6 max-sm:flex-col max-sm:items-start">
        ...
        <a
          ...
          className="inline-flex min-h-11 items-center text-sm font-bold underline decoration-1 underline-offset-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ink"
        >
