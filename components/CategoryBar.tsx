...
export default function CategoryBar({ onCategoryChange, onNavigate }: CategoryBarProps) {
  ...
  return (
    <nav
      className="category-bar fixed top-[80px] max-md:top-[64px] max-sm:top-[56px] left-0 z-40 w-full bg-[rgba(255,255,255,0.82)] backdrop-blur-md border-b border-[rgba(21,21,15,0.08)] py-2 max-sm:py-1.5 transition-colors duration-300"
    ...
    >
      <div className="w-[min(1380px,calc(100%-64px))] max-sm:w-[calc(100%-24px)] mx-auto flex items-center justify-center gap-2">
        <button
          ...
          className={`flex min-h-[44px] items-center gap-2 px-5 py-1.5 rounded-full text-[0.8rem] max-sm:text-[0.76rem] font-black tracking-wide transition-all duration-200 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-ink ${
