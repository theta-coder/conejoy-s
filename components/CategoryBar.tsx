...
export default function CategoryBar({ onCategoryChange, onNavigate }: CategoryBarProps) {
  ...
  return (
    <nav
      className="category-bar fixed top-[80px] max-md:top-[64px] max-sm:top-[56px] left-0 z-40 w-full bg-[rgba(255,255,255,0.82)] backdrop-blur-md border-b border-[rgba(21,21,15,0.08)] py-2 max-sm:py-1 transition-colors duration-300"
